...
@fig-shading shows the results for the overhang shading parametric analysis for north facing windows, south facing windows, and all windows for each block. The results indicate that, in most cases, as the overhang depth increases, the negative percent change in cooling demand also increases. For the case of Block 7 south facing windows, the energy demand increased. However, because the percentage increase is so low (\< 0.05%) the trend can be attributed to noise in the simulation. All other cases show a similar very small magnitude (\< 0.1%), thus the observed changes fall within the low-impact category and were not included in comparative analysis with other retrofits.
